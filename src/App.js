...
import { BrowserRouter as Router, Route, Routes, Link, NavLink, useNavigate } from "react-router-dom/dist"
    ...
    <Router>
      <AppBar position="fixed" color="primary" sx={{ paddingLeft: 0, paddingRight: 0 }}>
        <Toolbar>
          ...
          <Button className="transparent-button" style={{ marginLeft: "10px", backgroundColor: "transparent", color: "#fff" }} >
            Raise Request
          </Button>
        </Toolbar>
      </AppBar>

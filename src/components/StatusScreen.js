...
const EmployeeDetailsScreen = ({dropdownValue}) => {
  ...
  const employeeDetailsData = data.find((employee) => employee.employeeId === id);
  ...
  const [employeeDetails, setEmployeeDetails] = useState({
    ...
    VHUHVDHApprovedRetentionRequest: employeeDetailsData.VHUHVDHApprovedRetentionRequest,
    VHUHVDHComments:employeeDetailsData.VHUHVDHComments,
    VHUHVDHRejectionReason :employeeDetailsData.VHUHVDHRejectionReason,
    HRBPsApprovedRetentionRequest:employeeDetailsData.HRBPsApprovedRetentionRequest,
    HRBPComments:employeeDetailsData.HRBPComments,
    HRBPRejectionReason :employeeDetailsData.HRBPRejectionReason,
    HRGeoHeadsApprovedRetentionRequest:employeeDetailsData.HRGeoHeadsApprovedRetentionRequest,
  ...
  let steps;
    ...
    if (employeeDetails.VHUHVDHApprovedRetentionRequest===false && employeeDetails.VHUHVDHRejectionReason===null) {
       steps= ['Employee Details', 'VH/UH/VDH Approval']; // Show only the first step for ASDM
    } else if (employeeDetails.HRBPsApprovedRetentionRequest===false && employeeDetails.HRBPRejectionReason===null) {
      steps= ['Employee Details', 'VH/UH/VDH Approval', 'HRBP Approval']; // Show first two steps for VH/UH/VDH
    } else if (employeeDetails.HRGeoHeadsApprovedRetentionRequest===false && employeeDetails.HRGeoHeadsRejectionReason===null) {
      steps=['Employee Details', 'VH/UH/VDH Approval', 'HRBP Approval', 'HR Geo Head Approval']; // Show first three steps for HRBP
    } else if (employeeDetails.CpoApprovedRetentionRequest===false && employeeDetails.CpoRejectionReason===null) {
      steps= ['Employee Details', 'VH/UH/VDH Approval', 'HRBP Approval', 'HR Geo Head Approval', 'CPO Approval']; // Show first four steps for HR Geo Head
    } 
  ...
  const handleVhSubmit= ()=>{
    if(employeeDetails.VHUHVDHRejectionReason==='' || employeeDetails.VHUHVDHRejectionReason===null){
  ...
  const handlehrbpSubmit= ()=>{
    if(employeeDetails.HRBPRejectionReason==='' || employeeDetails.HRBPRejectionReason===null){
      setEmployeeDetails((prevDetails) => ({
        ...prevDetails,
  ...
  const handlehrgeoSubmit= ()=>{
    if(employeeDetails.HRGeoHeadsRejectionReason==='' || employeeDetails.HRGeoHeadsRejectionReason===null){
      setEmployeeDetails((prevDetails) => ({
        ...prevDetails,
  ...
  const handleCpoSubmit= ()=>{
    if(employeeDetails.CpoRejectionReason==='' || employeeDetails.CpoRejectionReason===null){
      setEmployeeDetails((prevDetails) => ({
        ...prevDetails,
        ...
        <Grid container spacing={2}>
              ...
              {steps.map((label, index) => (
                <StepperStep key={label}>
                  <Button onClick={() => handleStepClick(index)}>
                    <StepLabel icon={statusIcons[index]}>{label}</StepLabel>
                  </Button>
                </StepperStep>
              ))}
            </StepperContainer>
          ...
          <Grid item xs={12} sm={9}>
            <ScreenContainer>
              {activeStep === 0 && (
                <>
                  <Typography variant="h6">Manager has raised a request</Typography>
                  <Box mt={2}>
                ...
                <Grid item xs={8}>
                  <Typography>{employeeDetails.currentBillRate}</Typography>
                </Grid>
                <Grid item xs={4}>
                ...
                <Grid item xs={8}>
                  <Typography>{employeeDetails.offerLetterValidated}</Typography>
                </Grid>
                <Grid item xs={4}>
                ...
                <Grid item xs={8}>
                  <Typography>{employeeDetails.performanceRating}</Typography>
                </Grid>
                    </Grid>
                  </Box>
                </>
              ...
              {activeStep === 1 && (dropdownValue==='ASDM' || dropdownValue==='HRBP' || dropdownValue==='HR Geo Head' || dropdownValue==='CPO') &&(
                <>
                {(!employeeDetails.VHUHVDHApprovedRetentionRequest) && employeeDetails.VHUHVDHRejectionReason===null &&(
                  <Typography variant="h6">Waiting for VH/UH/VDH Approval</Typography>
                )}
                </>
              )}
              {activeStep === 1 && (dropdownValue==='VH/UH/VDH' ) && (employeeDetails.VHUHVDHApprovedRetentionRequest === false) &&(
                <>
                <>
                  ...
                  <Grid container spacing={1}>
                    ...
                    <Grid item xs={12}>
                      <Button variant="contained" color="primary" onClick={handleVhSubmit}>
                        Approve
                      </Button>
                      <Button variant="contained" color="error" style={{ marginLeft: '8px' }} onClick={handleVhSubmit}>
                        Reject
                      </Button>
                    </Grid>
                  </Grid>
              ...
              {activeStep === 2 && (dropdownValue==='ASDM' || dropdownValue==='VH/UH/VDH' || dropdownValue==='HR Geo Head' || dropdownValue==='CPO') &&(
                <>
                {(!employeeDetails.HRBPsApprovedRetentionRequest) && employeeDetails.HRBPRejectionReason===null &&(
                  <Typography variant="h6">Waiting for HRBPs Approval</Typography>
                )}
                </>
              )}
              {activeStep === 2 && (dropdownValue==='HRBP' ) && (!employeeDetails.HRBPsApprovedRetentionRequest) &&(
                ...
                <>
                  ...
                  <Grid container spacing={1}>
                    ...
                    <Grid item xs={12}>
                      <Button variant="contained" color="primary" onClick={handlehrbpSubmit}>
                        Approve
                      </Button>
              ...
              {activeStep === 2 && (dropdownValue==='HRBP' ) && (employeeDetails.HRBPsApprovedRetentionRequest)(
                ...
                <>
                  ...
                  <Grid container spacing={1}>
                    <Grid item xs={12}>
                      <Typography>HRBP Comments:</Typography>
                      <Typography>{employeeDetails.HRBPComments}</Typography>
                    </Grid>
                    <Grid item xs={12}>
                    {employeeDetails.HRBPRejectionReason===null &&(
                      <>
                      <Typography>Rejection Reason:</Typography>
                      <Typography>{employeeDetails.HRBPRejectionReason}</Typography>
                      </>
              ...
              {activeStep === 3 && (dropdownValue==='ASDM' || dropdownValue==='VH/UH/VDH' || dropdownValue==='HRBP' || dropdownValue==='CPO') &&(
                <>
                {(!employeeDetails.HRGeoHeadsApprovedRetentionRequest) && employeeDetails.HRGeoHeadsRejectionReason===null &&(
                  <Typography variant="h6">Waiting for HR Geo Heads Approval</Typography>
                )}
                </>
              )}
              {activeStep === 3 && (dropdownValue==='HR Geo Head' ) && (!employeeDetails.HRGeoHeadsApprovedRetentionRequest)(
                ...
                <>
                  ...
                  <Grid container spacing={1}>
                    ...
                    <Grid item xs={12}>
                      <Button variant="contained" color="primary" onClick={handlehrgeoSubmit}>
                        Approve
                      </Button>
                      <Button variant="contained" color="error" style={{ marginLeft: '8px' }}>
                        Reject
              ...
              {activeStep === 3 && (dropdownValue==='HR Geo Head' ) && (employeeDetails.HRGeoHeadsApprovedRetentionRequest)(
                ...
                <>
                  ...
                  <Grid container spacing={1}>
                    <Grid item xs={12}>
                      <Typography>HRBP Comments:</Typography>
                      <Typography>{employeeDetails.HRGeoHeadsComments}</Typography>
                    </Grid>
                    <Grid item xs={12}>
                    {employeeDetails.HRGeoHeadsRejectionReason===null &&(
                      <>
                      <Typography>Rejection Reason:</Typography>
                      <Typography>{employeeDetails.HRGeoHeadsRejectionReason}</Typography>
                      </>
              ...
              {activeStep === 4 && (dropdownValue==='ASDM' || dropdownValue==='VH/UH/VDH' || dropdownValue==='HRBP' || dropdownValue==='HR Geo Head') &&(
                <>
                {(!employeeDetails.CpoApprovedRetentionRequest) && employeeDetails.CpoRejectionReason===null &&(
                  <Typography variant="h6">Waiting for HR Geo Heads Approval</Typography>
                )}
                </>
              )}
              {activeStep === 4 && (dropdownValue==='CPO' ) && (!employeeDetails.CpoApprovedRetentionRequest)(
                ...
                <>
                  ...
                  <Grid container spacing={1}>
                    ...
                    <Grid item xs={12}>
                      <Button variant="contained" color="primary" onClick={handleCpoSubmit}>
                        Approve
                      </Button>
                      <Button variant="contained" color="error" style={{ marginLeft: '8px' }}>
                        Reject
              ...
              {activeStep === 3 && (dropdownValue==='HR Geo Head' ) && (employeeDetails.HRGeoHeadsApprovedRetentionRequest)(
                ...
                <>
                  ...
                  <Grid container spacing={1}>
                    <Grid item xs={12}>
                      <Typography>CPO Comments:</Typography>
                      <Typography>{employeeDetails.CpoComments}</Typography>
                    </Grid>
                    <Grid item xs={12}>
                    {employeeDetails.CpoRejectionReason===null &&(
                      <>
                      <Typography>Rejection Reason:</Typography>
                      <Typography>{employeeDetails.CpoRejectionReason}</Typography>
                      </>
